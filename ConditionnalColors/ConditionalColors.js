...
var explodedClouds = myCloud.ExplodeColor();
...
for (var i = 0; i < explodedClouds.CloudTbl.length; i++) {
...
var nbPoints = myCloud.GetNumber();
var nbPointsInSecundRange = explodedClouds.CloudTbl[tbl3[1]].GetNumber();
